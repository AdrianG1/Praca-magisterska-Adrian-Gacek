    ...
    for i in tqdm(range(3, 35, 775)):
        ...
        try:
            ...
            while not time_step1.is_last():
                ...
                dist1 = loaded_policy1.distribution(time_step1, policy_state1)
                policy_state1 = dist1.state
                time_step_1 = env1.step(float(dist1.action.loc))
                time_step1 = ts.TimeStep(
                ...
                # druga grzałka
                dist2 = loaded_policy2.distribution(time_step2, policy_state2)
                policy_state2 = dist2.state
                time_step_2 = env2.step(float(dist2.action.loc))
                time_step2 = ts.TimeStep(
                ...
                controls[0].append(float(dist1.action.loc))
                controls[1].append(float(dist2.action.loc))
